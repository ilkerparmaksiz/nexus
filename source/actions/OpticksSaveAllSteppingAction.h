// ----------------------------------------------------------------------------
// nexus | OpticksSaveAllSteppingAction.h
//
...
namespace nexus {
  ...
  class OpticksSaveAllSteppingAction: public G4UserSteppingAction
  {
  public:
    /// Constructor
    OpticksSaveAllSteppingAction();
    /// Destructor
    ~OpticksSaveAllSteppingAction();
...
inline StepContainer<G4String> OpticksSaveAllSteppingAction::get_initial_volumes(){return initial_volumes_;}
inline StepContainer<G4String> OpticksSaveAllSteppingAction::get_final_volumes  (){return   final_volumes_;}
inline StepContainer<G4String> OpticksSaveAllSteppingAction::get_proc_names     (){return      proc_names_;}

inline StepContainer<G4ThreeVector> OpticksSaveAllSteppingAction::get_initial_poss(){return initial_poss_;}
inline StepContainer<G4ThreeVector> OpticksSaveAllSteppingAction::get_final_poss  (){return   final_poss_;}
inline StepContainer<G4double>      OpticksSaveAllSteppingAction::get_times       (){return        times_;}
